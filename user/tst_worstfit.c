...
void _main(void)
{
	...
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 512 * Mega / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != (512 * Mega) / (1024 * PAGE_SIZE))
	...
	if ((usedDiskPages - sys_pf_calculate_allocated_pages()) != 15 * (2 * Mega) / PAGE_SIZE)
	...
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 1 * Mega / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	...
	if ((uint32)tempAddress != 0x8C900000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 4 * Mega / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x99000000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 6 * Mega / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x81400000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 5 * Mega / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x80400000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 2 * Mega / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x80000000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != (1 * Mega + 512 * kilo) / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x80600000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 512 * kilo / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x99600000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != 4 * kilo / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
	...
	if ((uint32)tempAddress != 0x99601000)
		panic("Worst Fit not working correctly");
	if ((sys_pf_calculate_allocated_pages() - usedDiskPages) != (2 * Mega - 4 * kilo) / PAGE_SIZE)
		panic("Wrong page file allocation: ");
	if ((freeFrames - sys_calculate_free_frames()) != 0)
		panic("Wrong allocation");
	cprintf("Test %d Passed \n", ++count);
