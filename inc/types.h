...
#define LOG_STATMENT(statment) \
	if (LOG_ENABLED)           \
	{                          \
		statment;              \
		cprintf("\n");         \
	}
#define LOG_VARS(string, cprintf_variable_arguments) \
	if (LOG_ENABLED)                                 \
	{                                                \
		cprintf(string, cprintf_variable_arguments); \
		cprintf("\n");                               \
	}
#define LOG_STRING(s)  \
	if (LOG_ENABLED)   \
...
#define LOG_STATMENT_NO_NEWLINE(a) \
	if (LOG_ENABLED)               \
	{                              \
		a;                         \
	}
